      ...
      <div className="layout ">
        <div className="flex flex-row justify-center  text-white">
          <div className="w-[600px]">
            <h1 className="font-[400px] text-[76px] ">MY CAPABILITIES</h1>
          </div>

          <div className="w-[600px] h-[241px] mt-5">
            <div>
              <p style={{ fontFamily: "Manrope" }} className="">
              ...
              {skills.map((skill) => {
                return (
                  <div key={skill} className="text-white">
                    <button className="border border-white rounded-full text-white  text-[14px] w-[124px] h-[54px] p-3 ">
                      {skill.title}
                    </button>
                  </div>
                );
