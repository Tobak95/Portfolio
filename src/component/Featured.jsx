...
const Featured = () => {
  return (
    <div className="layout  ">
      ...
      <div className="flex flex-col lg:flex-row justify-between mt-[100px]  lg:mt-25 lg:w-[1224px] text-white">
      ...
      <div className="flex flex-col lg:flex-row justify-between mt-25 lg:w-[1224px] text-white">
        <div className="lg:w-[600px] ">
